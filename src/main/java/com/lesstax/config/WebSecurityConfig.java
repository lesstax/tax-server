...
//// dont authenticate this particular request
                .authorizeRequests().antMatchers("/authenticate", "/client/client", "/client/sign-in", "/client/clients", "/client/verify-otp", "/client/reset-password", "/client/forgot-password").permitAll().
...
//// Add a filter to validate the tokens with every request
	...
	/*  @Override protected void configure(HttpSecurity http) throws Exception {
	  ...
	  .antMatchers("/client").authenticated() // .antMatchers(HttpMethod.GET,
